package com.company.example.dao.user;

import com.company.example.dao.AbstractExampleDAO;
...
public class UserDAO extends AbstractExampleDAO {
	...
	public boolean hasUser(String username, String userpassword) {
		return select().where("username = ? and userpwd = ?", username, userpassword).hasRecord();
	}
